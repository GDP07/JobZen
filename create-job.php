...
<main>
    ...
    <div class="create-job-wrapper">
        ...
        <form action="" id="createJobListing">

            <div class="input-container">
                <input required type="text" placeholder=" " id="jobTitle" name="jobTitle" autocomplete="off">
                <label for="jobTitle">Job title</label>
            </div>

            <div class="input-container with-drop-down">
                <input required type="text" placeholder=" " id="location" class="dynamic-dropdown" name="location" autocomplete="off">
            ...
            <div class="input-container with-drop-down">
                <input required type="text" placeholder=" " class="dynamic-dropdown" id="categories" name="categories" autocomplete="off">
            ...
            <div class="input-container with-drop-down">
                <input required type="text" placeholder=" " id="workingHours" class="dynamic-dropdown" name="workingHours" autocomplete="off">
            ...
            <div class="input-container">
                <input required type="number" placeholder=" " id="phoneNumber" name="phoneNumber" autocomplete="off">
                <label for="phoneNumber">Application contact number</label>
            </div>

            <div class="input-container">
                <input required type="text" placeholder=" " id="companyName" name="companyName" autocomplete="off">
                <label for="companyName">Company name</label>
            </div>

            <div class="input-container">
                <input type="text" placeholder=" " id="companyWebsite" name="companyWebsite" autocomplete="off">
                <label for="companyWebsite">Company website (optional)</label>
            </div>

            <div class="input-container">
                <input required type="email" placeholder=" " id="email" name="email" autocomplete="off">
                <label for="email">Application email</label>
            </div>

            <div class="input-container">
                <input type="number" placeholder=" " id="salary" name="salary" autocomplete="off">
                <label for="salary">Monthly salary (optional)</label>
            </div>

            <div class="input-container with-drop-down">
                <input required type="text" placeholder=" " class="dynamic-dropdown" id="preferredGender" name="preferredGender" autocomplete="off">
            ...
            <div class="input-container with-drop-down">
                <input required type="text" placeholder=" " class="dynamic-dropdown" id="minimumQualificationLevel" name="minimumQualificationLevel" autocomplete="off">
            ...
            <div class="input-container">
                <input type="number" placeholder=" " id="maxAge" name="maxAge" autocomplete="off">
                <label for="maxAge">Maximum age (optional)</label>
            </div>

            <div class="input-container">
                <input type="number" placeholder=" " id="minAge" name="minAge" autocomplete="off">
                <label for="minAge">Minimum age (optional)</label>
            </div>

            <div class="input-container">
                <input type="number" placeholder=" " id="experience" name="experience" autocomplete="off">
                <label for="experience">Minimum years of experience (optional)</label>
            </div>

            <div class="input-container show-image">
                <img id="previewImage" src="./images/4W1Vqj-LogoMakr.png" alt="">
            ...
            <div class="input-container with-image">
                <input type="file" name="bannerImage" id="bannerImage" accept="image/*" onchange="validateFileSize(this, 10485760)">
                <label for="bannerImage">Advertisement banner (optional)</label>
            </div>

            <div class="input-container with-image">
                <input required type="date" name="closingDate" id="closingDate">
                <label for="closingDate">Closing date</label>
            </div>

            <div class="input-container with-image">
                <input required type="time" name="closingTime" id="closingTime">
                <label for="closingTime">Closing time</label>
            </div>

            <div class="input-container with-textarea">
                <textarea required placeholder=" " name="jobDescription" id="jobDescription" cols="30" rows="10"></textarea>
