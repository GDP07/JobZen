...
<div class="hero">
    ...
    <h1>
        Navigate Your Career Path <br> with JobZen
    </h1>

    <form action="./job-listings.php" method="get">
        <div class="hero-input-wrapper">
            <div class="input-container with-drop-down">
                <input type="text" placeholder=" " id="location" class="dynamic-dropdown" name="location" autocomplete="off">
            ...
            <div class="input-container with-drop-down">
                <input type="text" placeholder=" " class="dynamic-dropdown" id="categories" name="category">
            ...
            <div class="input-container with-drop-down">
                <input type="text" placeholder=" " id="workingHours" class="dynamic-dropdown" name="type">
...
<main>
    ...
    <div class="job-display-wrapper">
        ...
        <div class="category-display-container home">
            <?php echo fetchTopCategoriesWithCount(); ?>
