...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $query = "SELECT * FROM job WHERE id = ? AND posted_by = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("ii", $jobId, $_SESSION['uid']);
    $stmt->execute();
...
?>
        ...
        <main>
            ...
            <div class="create-job-wrapper">
                ...
                <form action="" id="updateJobListing">

                    <input type="hidden" name="jobId" value="<?php echo $job['id'] ?>">

                    <div class="input-container">
                        <input required type="text" placeholder=" " id="jobTitle" name="jobTitle" autocomplete="off" value="<?php echo $job['title'] ?>">
                        <label for="jobTitle">Job title</label>
                    </div>

                    <div class="input-container with-drop-down">
                        <input required type="text" placeholder=" " id="location" class="dynamic-dropdown" name="location" autocomplete="off" value="<?php echo $job['location'] ?>">
                    ...
                    <div class="input-container with-drop-down">
                        <input required type="text" placeholder=" " class="dynamic-dropdown" id="categories" name="categories" autocomplete="off" value="<?php echo $job['category'] ?>">
                    ...
                    <div class="input-container with-drop-down">
                        <input required type="text" placeholder=" " id="workingHours" class="dynamic-dropdown" name="workingHours" autocomplete="off" value="<?php echo $job['job_type'] ?>">
                    ...
                    <div class="input-container">
                        <input required type="number" placeholder=" " id="phoneNumber" name="phoneNumber" autocomplete="off" value="<?php echo $job['contact_number'] ?>">
                        <label for="phoneNumber">Application contact number</label>
                    </div>

                    <div class="input-container">
                        <input required type="email" placeholder=" " id="email" name="email" autocomplete="off" value="<?php echo $job['contact_email'] ?>">
                        <label for="email">Application email</label>
                    </div>

                    <div class="input-container">
                        <input required type="text" placeholder=" " id="companyName" name="companyName" autocomplete="off" value="<?php echo $job['company'] ?>">
                        <label for="companyName">Company name</label>
                    </div>

                    <div class="input-container">
                        <input type="text" placeholder=" " id="companyWebsite" name="companyWebsite" autocomplete="off" value="<?php echo $job['company_url'] ?>">
                        <label for="companyWebsite">Company website (optional)</label>
                    </div>

                    <div class="input-container">
                        <input type="number" placeholder=" " id="salary" name="salary" autocomplete="off" value="<?php echo $job['monthly_pay'] ?>">
                        <label for="salary">Monthly salary (optional)</label>
                    </div>

                    <div class="input-container with-drop-down">
                        <input required type="text" placeholder=" " class="dynamic-dropdown" id="preferredGender" name="preferredGender" autocomplete="off" value="<?php echo $job['preferred_gender'] ?>">
                    ...
                    <div class="input-container with-drop-down">
                        <input required type="text" placeholder=" " class="dynamic-dropdown" id="minimumQualificationLevel" name="minimumQualificationLevel" autocomplete="off" value="<?php echo $job['minimum_qualification_level'] ?>">
                        <label for="minimumQualificationLevel">Minimum qualification level</label>
                        <button class="clearButton" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <path d="M376.6 84.5c11.3-13.6 9.5-33.8-4.1-45.1s-33.8-9.5-45.1 4.1L192 206 56.6 43.5C45.3 29.9 25.1 28.1 11.5 39.4S-3.9 70.9 7.4 84.5L150.3 256 7.4 427.5c-11.3 13.6-9.5 33.8 4.1 45.1s33.8 9.5 45.1-4.1L192 306 327.4 468.5c11.3 13.6 31.5 15.4 45.1 4.1s15.4-31.5 4.1-45.1L233.7 256 376.6 84.5z" />
                            </svg>
                    ...
                    <div class="input-container">
                        <input type="number" placeholder=" " id="maxAge" name="maxAge" autocomplete="off" value="<?php echo $job['maximum_age'] ?>">
                        <label for="maxAge">Maximum age (optional)</label>
                    </div>

                    <div class="input-container">
                        <input type="number" placeholder=" " id="minAge" name="minAge" autocomplete="off" value="<?php echo $job['minimum_age'] ?>">
                        <label for="minAge">Minimum age (optional)</label>
                    </div>

                    <div class="input-container">
                        <input type="number" placeholder=" " id="experience" name="experience" autocomplete="off" value="<?php echo $job['minimum_years_experience'] ?>">
                        <label for="experience">Minimum years of experience (optional)</label>
                    </div>

                    <div class="input-container show-image" style="<?php echo $job['banner_image'] == '' ? '' : 'display:flex' ?>">
                        <img id="previewImage" src="./jobBanners/<?php echo $job['banner_image'] ?>" alt="">

                        <input type="hidden" value="" name="removedImage" id="removedImage">
                        <input type="hidden" value="<?php echo $job['banner_image'] ?>" name="imageNotEmpty" id="imageNotEmpty">
                        <button type="button" id="clearImageUpdateBtn">
                    ...
                    <div class="input-container with-image">
                        <input type="file" name="bannerImage" id="bannerUpdateImage" accept="image/*" onchange="validateFileSize(this, 10485760)" value="<?php echo $job['banner_image'] ?>">
                        <label for="bannerImage">Advertisement banner (optional)</label>
                    </div>

                    <div class="input-container with-image">
                        <input required type="date" name="closingDate" id="closingDate" value="<?php echo $job['closing_date'] ?>">
                        <label for="closingDate">Closing date</label>
                    </div>

                    <div class="input-container with-image">
                        <input required type="time" name="closingTime" id="closingTime" value="<?php echo $job['closing_time'] ?>">
                        <label for="closingTime">Closing time</label>
                    </div>

                    <div class="input-container with-textarea">
                        <textarea required placeholder=" " name="jobDescription" id="jobDescription" cols="30" rows="10"><?php echo $job['description'] ?></textarea>
